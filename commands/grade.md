...
Write a markdown file to the current working directory named `[company-name-lowercase]-saas-analysis.md`.

The file must follow this EXACT structure:

```markdown
# SaaS Optimization Analysis: [Company Name]
